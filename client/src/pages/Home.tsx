...
import LeadActivityReports from "@/components/LeadActivityReports";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    else if (location === "/lead-activities") setCurrentView("lead-activities");
